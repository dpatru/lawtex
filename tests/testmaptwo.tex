...
\begin{LTXexample}
  \def\maptwo#1#2#3{{% create a block to restrict the scope
    \def\endlist{\endlist}% mark the end of the list
    \makeatletter
    \def\@maptwo##1##2;##3\endlist##4;##5\endlist{%
      ...
      \@maptwo{##1}##3\endlist{}##5\endlist\fi\fi}
    \@maptwo{#1}#2;\endlist{}#3;\endlist}}
