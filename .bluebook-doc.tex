...
\cmd{citecase}[Short Name]{Standard Case Citation}[Defines a new case citation, using standard citation form.]
   \citecase{Miller-Davis v. Ahrens Const., 296 Mich. App. 56; 817 N.W.2d 609 (2012)}
 \begin{Example}
   ...
   \pincite{Miller-Davis}{57; 610}
 \end{Example}
 \noindent To cite legal sources in the body of the text, first include a _\citecase_ command with the 
 ...
 Separate parallel cites with a semicolon and space. This applies
 both when defining the case with a _\citecase_ and when citing it
 with _\pincite_.
...
\cmd{newcase}{Short Name}{Full Name}{Reporter}{Starting Page}{Parenthetical}[Defines a new case citation.]
 ...
 For parallel citations, separate the reporters and starting pages
 with a semicolon followed by a space as in _\citecase_. Up to three
 reporters and three start pages are allowed.
...
1) The references in the Statutes index can appear in the wrong order or
 ...
 \newstatute[1@am2]{\textsc{U.S. Const.} amend. I} - use am2 as the
